  ...
  data: [
    {
      ...
      time: '2019-04-07T12:00',
      title: 'Event 1',
      notification: false,
    },
    {
      id: 'event2',
      description: 'Lorem ipsum event description',
...
export const CALENDAR: { data: EventsOnDate[] } = {
  data: [
    ...
    {
      date: '2019-04-03',
      events: [{ title: 'Calendar event 1', id: '5ca48f38838382998f903e36' }],
    },
    { date: '2019-04-04', events: [] },
    {
      date: '2019-04-05',
      events: [{ title: 'Calendar event 2', id: '5ca713caf3a8a00031740b6b' }],
    },
    ...
    { date: '2019-04-09', events: [] },
    {
      date: '2019-04-10',
      events: [
        { title: 'Calendar event 30', id: '5ca71459f3a8a00031740b6c' },
        { title: 'Calendar event 31', id: '5ca71459f3a8a02341740b6c' },
        { title: 'Calendar event 32', id: '5ca71459f3a8a01231740b6c' },
      ],
    },
    {
      date: '2019-04-11',
      events: [{ title: 'Calendar event 4', id: '5ca4925a385642003103fc14' }],
    },
    {
      date: '2019-04-12',
      events: [{ title: 'Calendar event 5', id: '5ca5ea7a3353960031b8b5eb' }],
    },
    ...
    {
      date: '2019-04-25',
      events: [{ title: 'Calendar event 6', id: '5ca5ea8b3353960031b8b5ec' }],
    },
